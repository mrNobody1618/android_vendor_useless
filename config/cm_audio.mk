...
ALARM_PATH := vendor/useless/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/useless/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/useless/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/useless/prebuilt/common/media/audio/ui
